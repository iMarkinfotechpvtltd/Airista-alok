...
class WonderPlugin_Slider_View {
	...
	function import_export() {
		...
		<p>This function only imports and exports slider configurations. It does NOT import and export media files.</p>
		
		<p>The plugin uses WordPress Media Library to manage media files. For how to transfer WordPress Media Library, please view <a href="https://www.wonderplugin.com/how-to-transfer-wordpress-media-library/" target="_blank">How to transfer WordPress Media Library</a>.</p>	
