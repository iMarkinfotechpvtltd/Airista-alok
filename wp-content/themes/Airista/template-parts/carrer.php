...
get_header(); ?>   
    ...
    <div class="banner banner-main-inner" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/career-banner.jpg)">
        <div class="container">
		...
		<path clip-path="url(#SVGID_2_)" fill="#F26722" d="M184.689,115.205c0.667-1.187,0.625-2.701-0.23-3.871l-12.423-16.96
			...
			L168.12,134.865z M168.12,134.865"/>
              ...
              <!--  <img src="images/career-banner-icon.png" class="img-responsive">-->
                ...
                <p>AiRISTA Flow is continuously searching for brilliant employees with an entrepreneurial spirit, looking for a work culture where innovation is the goal</p>
            </div>
    ...
    <div class="food-hospitality-main career-main">
        <div class="container">
            <div class="food-hospitality-top">
                <h2>WE NEED YOU</h2>
                <p>AiRISTA Flow is continuously searching for brilliant employees with an entrepreneurial spirit, looking for a work culture where innovation is the goal, hard work is expected, and creativity is rewarded. Ekahau employees enjoy a competitive compensation package, innovative working environment, challenging job and a network of like-minded, highly performing co-workers that drive wireless innovation across several industries.</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                         <div class="currt-open-img">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/career-img-1.jpg" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                         <div class="currt-open-text">
                            <h3>Current job openings</h3>
                             ...
                             <a href="#" class="org-btn">apply now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="currt-open-btm">
                <div class="container">
                    <a href="#" class="org-btn">CURRENT OPENINGS</a>
                    <p> Visit us on http://www.linkedin.com/airistaflow or email your resume to <a href="mailto:careers@airistaflow.com">careers@airistaflow.com</a></p>
                </div>
            </div>
