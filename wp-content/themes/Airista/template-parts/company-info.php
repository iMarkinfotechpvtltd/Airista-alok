...
if($image==""){
?>
<div class="banner banner-main-inner" style="background-image:url(http://placehold.it/1920x648&amp;text=1920x690);)">
<?php }	else{  ?>
    ...
    <div class="food-hospitality-main company-info-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-5 col-xs-12 make-va">
						...
						<?php
                        $img=get_post_meta(23,"mission_section_image",true);
                        $thumb = wp_get_attachment_image_src($img, 'mission-image' );?>
		                <?php if($thumb==""){?>
		                <img src="http://placehold.it/376x315&amp;text=No image found" alt="Image"/>
		                <?php
		                }else{?>
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12 make-va">
						 ...
						 <?php the_field('mission_section_text',23); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    <li><h6>AMERICA</h6> AiRISTA Flow, Americas (Headquarters)<br>
913 Ridgebrook Rd., Suite 110 Sparks, MD 21152</li>
                    <li><h6>FINLAND</h6> AiRISTA Flow International, Finland iilikatu 3, 00180<br> Helsinki, Finland
</li>
                    <li><h6>GET IN TOUCH</h6> <a href="mailto:info@airistaflow.com ">info@airistaflow.com </a><br> <a href="#">1-844-RTLS-NOW</a></li>
                </ul>
            </div>
                </div>
            </div>
