...
get_header(); ?>  
    ...
    <div class="banner banner-main-inner" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/deployment-banner.jpg)">
        <div class="container">
            <div class="banner-inner-text wow fadeIn" data-wow-duration="1s">
                ...
                <p>How We Simplify Business Intelligence Through Location</p>
            </div>
    ...
    <div class="food-hospitality-main deployment-main">
        <div class="container">
            <div class="food-hospitality-top">
                <h2>Our RTLS Deployment Process</h2>
                <p>Our experienced team of RTLS engineers arrives on site to work with your team and ensure a successful deployment. 
Your AiRISTA Flow RTLS is deployed in three easy steps:</p>
            </div>
        ...
        <div class="deployment-gray-sec">
                ...
                <div class="depl-gray-top">
                    ...
                    <div class="depl-gray-left ">
                        <h4>1. Site Survey & Site Walk</h4>
                        <ul>
                            <li>A. On-site facility walk-throughs to determine 
initial requirements and assess your WLAN RF 
environment (RSSI) with heat maps and RTLS 
readiness analysis. </li>
                        </ul>
                        
                        
                    </div>
                    <div class="depl-gray-right">
                        <h4>3. Installation & Optimization</h4>
                        <ul>
                            <li>A. Each project receives professional project 
management from start to finish, on site so that your projects are on time and on budget. We do all the work so you don’t have to.  </li>
                        </ul>
                    </div>
                </div>
                    </div>
                ...
                <div class="depl-gray-bottom">
                    <div class="depl-gray-center  " >
                        <h4>2. Rough-Order-of Magnitude </h4>
                        <ul>
                            <li>A. Blueprints are obtained for accurate location mapping within the Ekahau system.</li>
                            <li>B. We load each blueprint/floor plan map from your 
facility dynamically into our system in a matter of 
minutes.</li>
                            <li>C. Location tracking tags are tested on site and activated over the air.</li>
                            <li>D. Business logic inside of our software platforms help you track and measure what’s important to you, quickly querying and reporting the results so you have business intelligence that’s actionable</li>
                        </ul>
                    </div>
        ...
        <div class="site-survey-bottom depl-white-sec">
            <div class="container">
                <h5>Ready to take the next step? Contact us for a custom quote and implementation plan.</h5>
                <a href="#" class="org-btn">GET A QUOTE</a>
            </div>
        </div>
