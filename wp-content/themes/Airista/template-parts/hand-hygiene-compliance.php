...
get_header(); ?>    
    ...
    <div class="banner banner-main-inner" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/hand-hygiene-compliance-banner.jpg)">
        <div class="container">
    ...
    <div class="food-hospitality-main hand-hygiene-main">
        <div class="container">
            ...
            <div class="hand-hygiene-mid-banner">
             ...
             $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'hand-hygiene-image' );
		      ?>
