...
get_header(); ?> 
    ...
    <div class="banner banner-main-inner" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/manufacturing-banner.jpg)">
        <div class="container">
    ...
    <div class="manufa-main">
        ...
        <div class="manfa-gray">
            <div class="container">
                ...
                <?php 
		    $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'manufacturing-image' );
		      if($image==""){
			?>
            <div class="go-beyond-right" style="background-image:url(http://placehold.it/705x726&amp;text=705x726);)">
			
			<?php }	else{  ?>
              <div class="go-beyond-right" style="background-image:url(<?php echo $image[0]; ?>);">
		   <?php } ?>
                </div>
            </div>
