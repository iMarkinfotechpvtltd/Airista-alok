...
get_header(); ?> 
    ...
    <div class="banner banner-main-inner" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/industries-others-banner.jpg)">
        <div class="container">
            <div class="banner-inner-text wow fadeIn" data-wow-duration="1s">
                <svg x="0px" y="0px"
	 viewBox="0 0 460.438 460.438" width="60px" height="70px">
<g id="XMLID_11_">
	...
	<path id="XMLID_989_" d="M311.303,303.22c0-4.158-3.371-7.529-7.529-7.529h-3.187v-15.307c1.781-1.271,3.329-2.845,4.554-4.658h0
		...
		h27.561c4.158,0,7.529-3.371,7.529-7.529V303.22z"/>
                ...
                <!--<img src="images/industries-others-icon.png" class="img-responsive">-->
                <h1><?php the_title();?></h1>
    ...
    <div class="food-hospitality-main indu-other-main">
        <div class="container">
            <div class="food-hospitality-top">
                
                <?php the_field('aerospace',$post->ID);?> 
    ...
    <div class="indu-other-bottom">
        <div class="container">
                <div class="go-beyond-left">
                    <div class="go-beyond-left-inner">
                     <?php the_field('oil_&_gas,_mining',$post->ID);?>   
                   
                    <div class="go-beyond-left-list">
                    <?php the_field('solutions_are_built_to_help',$post->ID);?>
                ...
                <?php 
		        $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'other-image' );
		        if($image==""){
			    ?>
                <div class="go-beyond-right" style="background-image:url(http://placehold.it/659x946&amp;text=659x946);)">
