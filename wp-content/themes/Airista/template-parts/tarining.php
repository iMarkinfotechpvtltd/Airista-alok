...
get_header(); ?>    
    ...
    <div class="banner banner-main-inner" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/training-classes-banner.jpg)">
        <div class="container">
    ...
    <div class="food-hospitality-main training-classes-main">
        <div class="container">
            <div class="food-hospitality-top">
                ...
                <p>Ekahau Certified RTLS Engineer (ECRE) training, from AiRISTA Flow, is an intensive four-day technical course designed for partners and customers who need in-depth training in the implementation and support of the entire Ekahau Real Time Location Solution (RTLS). ECRE covers the complete RTLS solution and provides a blend of instructor-led lectures and hands-on exercises which allow attendees to gain valuable experience and best practices. Classes are held periodically in our Reston, VA, office or may be held onsite at your location (for qualified partners only.)</p>
            </div>
        ...
        <div class="training-dates-cvr">
            <div class="container">
                 <h4>US training dates for 2016</h4>
                
                <div class="training-dates-list">
                    <ul>
                        <li><img src="<?php echo get_template_directory_uri(); ?>/images/jul.png" class="img-responsive"></li>
                        <li><img src="<?php echo get_template_directory_uri(); ?>/images/aug.png" class="img-responsive"></li>
                        <li><img src="<?php echo get_template_directory_uri(); ?>/images/sep.png"  class="img-responsive"></li>
                        <li><img src="<?php echo get_template_directory_uri(); ?>/images/oct.png" class="img-responsive"></li>
                        <li><img src="<?php echo get_template_directory_uri(); ?>/images/nov.png" class="img-responsive"></li>
                    </ul>
                    
                    <a href="#" class="org-btn">REGISTER FOR ECRE</a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/training-classes-img-1.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 col-md-offset-1 col-sm-7 col-xs-12">
                        <p><b>Ekahau Certified RTLS Administrator (ECRA)</b> training is a two-day course designed to provide customized onsite administrative instruction utilizing the site’s actual i
nfrastructure and WLAN in a test environment. The goal of the course is to ensure that participants obtain complete end-to-end training on Ekahau RTLS and have 
a viable lab environment that can be used for education, testing, and issue 
resolution going forward.</p>
                        <a href="#" class="org-btn">REGISTER FOR ECRA</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="custm-training-cvr">
                <h4>Custom Onsite Training Options</h4>
                <p>The Ekahau Professional Services team is highly-trained and experienced we offer a complete range of management, implementation, training, and Site-Survey services designed to ensure that you are successful with Ekahau solutions. Contact your sales representative or fill our this short form for a service request.</p>
                <a href="#" class="org-btn">MORE INFO</a>
            </div>
