	...
	<g>
		<g>
			...
			<path d="M258.434,339.103l-66.419-26.48l-15.554-13.107c-4.108-3.471-10.176-3.215-13.986,0.574l-21.624,21.504l-21.688-21.511
                ...
                <h1>Case studies overview</h1>
                <div class="spacer"></div>
                <p><?php echo get_post_meta(275, "content_for_inner_case_studies_page_on_banner", true); ?></p>
            </div>
                       ...
                       <?php while ( have_posts() ) : the_post();?>
                           ...
                           <?php } ?>	
                            ...
                            <div class="blog-descp">
								...
								<?php $pdf = get_post_meta($post->ID, 'pdf_upload_for_content', true); ?>
					           <?php if ($pdf): ?> 
                               <a href="<?php echo wp_get_attachment_url($pdf); ?>" class="rs-download-btn">Download Case Study as a PDF »</a>
							   <?php endif; ?>
                                <?php the_content(); ?>
