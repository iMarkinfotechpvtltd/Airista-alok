...
?>
     ...
     <?php 
		        $postblog = get_post_meta(8,"blog_banner",true);
...
<g>
	<g>
		<g>
			...
			<path d="M258.434,339.103l-66.419-26.48l-15.554-13.107c-4.108-3.471-10.176-3.215-13.986,0.574l-21.624,21.504l-21.688-21.511
                ...
                <p><?php echo get_post_meta(8, "content_on_inner_bloge_page_on_banner", true); ?></p>
            </div>
    ...
    <div class="blog-main">
        <div class="container">
            <div class="blog-cover blog-inner">
                <div class="blog-left">
                    <div class="blog-post">
                       ...
                       <?php while ( have_posts() ) : the_post();?>
                            ...
                            $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'inner-blog-image' );
				            ?>
                  ...
                  <div class="blog-sidebar">
                    ...
                    <div class="blog-recent-post">
                     ...
                     <div class="blog-tags">
                         ...
                         <ul>
						 <?php $tag = wp_get_post_tags($post->ID); foreach( $tag as $tag ) {?><li><a href="#"><?php  echo $tag->name;?></a></li><?php }?>
                         </ul>
