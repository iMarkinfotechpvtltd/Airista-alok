        ...
        <div class="education-grey">
            <div class="container">
                <div class="education-white">
                    <h2><?php the_field('prioritze_school_safety');?></h2>
                    
                    <div class="edu-white-left">
                    
                  <?php
                          $miss=get_post_meta($post->ID,"image_for_prioritze_school_safety",true);
                          $thumb = wp_get_attachment_image_src($miss, 'first-education-image' );?>
		                  <?php if($thumb==""){?>
                    ...
                    <div class="edu-white-right">
                        <?php the_field('with_a_variety_of_technologies');?>
        ...
        <div class="go-beyond-sec">
            <div class="container">
                <div class="go-beyond-left">
                    <div class="go-beyond-left-inner">
                       <?php the_field('go_beyond_security');?>
                    <div class="go-beyond-left-list">
                    <?php the_field('airista_flow_solutions_help');?>
            ...
            <div class="container">
                <ul class="go-bey-end-list">
					...
					<?php if ($file): ?>
					<p><?php the_field('healthcare_brochure');?></p>
					...
					<?php $hospital = get_post_meta($post->ID, 'hospital_assets_file_upload', true); 
				     if ($hospital): ?>
					<p><?php the_field('hospital_assets');?></p>
                     <a href="<?php echo wp_get_attachment_url($hospital); ?>" class="org-btn">download</a>
					 <?php endif; ?>
                    </li>
                    
                    <li><p><?php the_field('hospital_leverages');?></p>
