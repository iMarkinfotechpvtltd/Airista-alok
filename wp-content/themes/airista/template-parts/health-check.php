    ...
    <div class="healthcheck-main">
        <div class="container">
            <div class="healthcheck-main-text">
             <?php the_field('healthcheck_program_and_every_smart_investment',$post->ID);?>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="health-list">
                             <?php the_field('the_airista_flow_health_and_two_days_of_on-site',$post->ID);?>
                        </div>
                        
                        <div class="health-list">
                             <?php the_field('why_enroll_in_airista_flow_rtls_health_check_and_keep_your_rtls_in_optimal',$post->ID);?>
                        </div>
        ...
        <div class="healthcheck-shd">
            <div class="container">
                <p>  <?php the_field('schedule_your_next_rtls_health_check',$post->ID);?></p>
                <a href=" <?php the_field('link_for_schedule_now',$post->ID);?>" class="org-btn"> <?php the_field('schedule_now',$post->ID);?></a>
            </div>
        </div>
