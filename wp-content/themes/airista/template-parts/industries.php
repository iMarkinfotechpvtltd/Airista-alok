...
<?php while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="indust-main">
        <div class="container">
            <h2><?php the_field('discover_solutions',232);?></h2>
...
<g>
	<g>
		...
		<circle style="fill:#010002;" cx="27.433" cy="12.972" r="4.366"/>
                        ...
                        <h5><?php the_field('healthcare');?></h5>
                        <div class="indust-item-text"><p><?php the_field('healthcare_text');?></p></div>
                        <a href="<?php the_field('healthcare_link');?>" class="org-read-btn">read more</a>
                    </div>
                </div>
  ...
  <g>
    ...
    <path d="m306.574,337.083c0.559,0 1.127-0.063 1.695-0.194 5.66-1.308 11.236-2.826 16.573-4.515 3.949-1.249 6.138-5.463 4.889-9.412s-5.462-6.14-9.413-4.89c-4.96,1.569-10.15,2.982-15.425,4.201-4.036,0.932-6.552,4.959-5.62,8.995 0.802,3.469 3.888,5.815 7.301,5.815z"/>
                        ...
                        <h5><?php the_field('education');?></h5>
                        <div class="indust-item-text"><p><?php the_field('education_text');?></p></div>
                        <a href="<?php the_field('education_link');?>" class="org-read-btn">read more</a>
                    </div>
                </div>
	...
	<path d="M276.619,38.115c-2.046-3.158-2.703-5.292-2.703-5.292l0.975-0.897c0,0,1.896,0.788,5.21,2.146
		...
		l17.14-223.139h52.313l15.002,223.139h35.196v65.653h18.446V351.03z M149.375,301.975H77.461v66.387h71.914V301.975z
		 M273.293,301.975h-71.916v66.387h71.916V301.975z M398.768,301.975h-71.914v66.387h71.914V301.975z"/>
                        ...
                        <h5><?php the_field('manufacturing');?></h5>
                         <div class="indust-item-text"><p><?php the_field('manufacturing_text');?></p></div>
                        <a href="<?php the_field('manufacturing_link');?>" class="org-read-btn">read more</a>
                    </div>
                </div>
...
<g>
	<g>
		...
		<polygon points="0,265.261 0,361.394 67.83,348.694 50.861,256.313 		"/>
                        ...
                        <h5><?php the_field('food_services');?></h5>
                        <div class="indust-item-text"><p><?php the_field('food_services_text');?></p></div>
                        <a href="<?php the_field('food_services_link');?>" class="org-read-btn">read more</a>
                    </div>
                </div>
...
<g>
	<g>
		...
		<rect x="42.38" y="89.061" width="6.164" height="24.892"/>
                        ...
                        <h5><?php the_field('government');?></h5>
                        <div class="indust-item-text"><p><?php the_field('government_text');?></p></div>
                        <a href="<?php the_field('government_link');?>" class="org-read-btn">read more</a>
                    </div>
                </div>
...
<g id="XMLID_11_">
	...
	<path id="XMLID_989_" d="M311.303,303.22c0-4.158-3.371-7.529-7.529-7.529h-3.187v-15.307c1.781-1.271,3.329-2.845,4.554-4.658h0
		...
		h27.561c4.158,0,7.529-3.371,7.529-7.529V303.22z"/>
                        ...
                        <h5><?php the_field('other');?></h5>
                        <div class="indust-item-text"><p><?php the_field('other_text');?></p></div>
                        <a href="<?php the_field('other_link');?>" class="org-read-btn">read more</a>
                    </div>
                </div>
