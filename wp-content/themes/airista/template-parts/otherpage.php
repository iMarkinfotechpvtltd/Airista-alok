        ...
        <div class="container">
                <div class="go-beyond-left">
                    <div class="go-beyond-left-inner">
                     <?php the_field('text_for_mining_gas',$post->ID);?>   
                   
                    <div class="go-beyond-left-list">
                    <?php the_field('solutions_are_built_to_help_address',$post->ID);?>
                ...
                <?php 
		        $oth = get_post_meta($post->ID,"image_for_solutions_are_built_to_help",true);
				$thumb = wp_get_attachment_image_src($oth, 'other-image');
