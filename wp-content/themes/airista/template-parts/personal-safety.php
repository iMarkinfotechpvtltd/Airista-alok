        ...
        <div class="container">
            ...
            <div class="personal-safety-list">
                <div class="personal-safety-item">
                    ...
                    <figure> 
                    <?php
                       $saf=get_post_meta($post->ID,"image_for__an_instant_lifeline_to_help_",true);
                       $thumb = wp_get_attachment_image_src($saf, 'personal-safety-image-image' );?>
		               <?php if($thumb==""){?>
		               <figure> <img src="http://placehold.it/583x473&amp;text=No image found" alt="<?php the_title(); ?>"/> </figure>
		                <?php
		                }else{?>
